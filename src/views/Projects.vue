         ...
         <div class="row">
            ...
            <div class="col-md-4">
             ...
             <div class="col-md-4">
               <div class="prj-item">
                  <div class="zoomin">
                     <img src="../assets/images/portfolio7.jpg" />
                  </div>
                  <div
                     class="d-flex justify-content-between align-items-center prj-content"
                  >
                     <h3>Aceplus Solutions</h3>
                     <div>
                        <a
                           href="https://aceplussolutions.com/"
                           target="_blank"
                        >
                           <img src="../assets/images/goto.png" alt="Systematic" />
                        </a>
             ...
             <div class="col-md-4">
               <div class="prj-item">
                  ...
                  <div
                     class="d-flex justify-content-between align-items-center prj-content"
                  >
                     <h3>SLCS Logistics</h3>
                     <div>
                        <a
                           href="https://slcslogistics.com/"
                           target="_blank"
                        >
                           <img src="../assets/images/goto.png" alt="Systematic" />
                        </a>
             ...
             <div class="col-md-4">
               <div class="prj-item">
                  ...
                  <div
                     class="d-flex justify-content-between align-items-center prj-content"
                  >
                     <h3>GGI Tokio Marine</h3>
                     <div>
                        <a
                           href="https://ggitokiomarine.com/"
                           target="_blank"
                        >
                           <img src="../assets/images/goto.png" alt="Systematic" />
                        </a>
